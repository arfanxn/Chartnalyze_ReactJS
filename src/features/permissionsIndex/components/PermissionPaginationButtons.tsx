...
const PermissionPaginationButtons = forwardRef<HTMLDivElement, Props>(
    ({ className, ...props }, ref) => {
...
PermissionPaginationButtons.displayName = 'PermissionPaginationButtons'

export default PermissionPaginationButtons
